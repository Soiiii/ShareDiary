...
<c:forEach items="${dto}" var="dto">
	...
	<c:choose >
		...
		<c:otherwise>
			...
			<div align=${direc } style=" width:500px; height: 50%; background: linear-gradient(to bottom right, ${color1}, ${color2}); color:white; border-radius: 2em;">
			<br>
			<br>
			<div>${dto.title }</div>
			<div>날짜: ${dto.date }</div>
...
<div align="right" style = "width:80px"><button onclick ="location.href = ('./EdDetail');">답글쓰기</button></div>
</div>
</div>
